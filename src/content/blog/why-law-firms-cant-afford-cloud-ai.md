...
<figure style="text-align:center; margin:2rem 0;">
  <img src="/blog/air-gapped-right-meme.jpg" alt="Anakin and Padmé meme — 'We are building an incredibly secure AI app!' followed by 'And it's air gapped right?' and then just: 'Right?'" style="max-width:480px; width:100%; border-radius:8px;" />
  <figcaption style="font-size:0.85rem; color:#888; margin-top:0.5rem;">The question every compliance partner is already asking.</figcaption>
</figure>
