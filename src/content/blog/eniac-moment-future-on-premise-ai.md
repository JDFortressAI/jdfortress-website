...
The hardware is capable. But it's also bigger, [more expensive](/blog/the-memory-wall), and more power-hungry than it needs to be — because the underlying technology hasn't yet found its most efficient form.
