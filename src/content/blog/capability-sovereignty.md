...
The April crackdown is not a one-off. It is a preview of what happens when capability is leased from a centralised provider navigating its own commercial, regulatory, and reputational pressures. Anthropic made a reasonable safety decision that had severe downstream consequences for businesses that had made reasonable commercial decisions. There was no bad actor in this story. The architecture itself is the problem.
