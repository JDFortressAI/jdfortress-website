...
**The data sovereignty problem:** Every trace ends up in someone else’s data centre.
...
- **E3** — controlled experiment (A/B tests, randomised trials)
...
**Persistent private platform, 17,921 value episodes auto-classified from artefacts** (no raw chats, no self-reported metrics).

**Headline stats:**
- **~182,000 HEE hours** = 88 person-years
- **£32M in artefact replacement value** (3.5× professional-services markup)
...
Most “AI productivity” noise is still vapourware. **Real economic impact clusters in verifiable, high-magnitude primitives** — and only organisations that keep the data inside their own walls can actually capture and prove it without triggering a regulator.
...
The hardware and sovereignty realities echo what we’ve been saying about [the Memory Wall](/blog/the-memory-wall) and [capability sovereignty](/blog/capability-sovereignty): bandwidth, cost, and compliance all point the same direction — **private infrastructure**.
